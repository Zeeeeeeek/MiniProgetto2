...
public class AdjacencyMatrixUndirectedGraph<L> extends Graph<L> {
    ...
    public void removeNode(GraphNode<L> node) {
        ...
        matrix.remove(index);
        //Rimuovo l'ultima colonna ad ogni riga
        for(ArrayList<GraphEdge<L>> row : matrix) {
            row.remove(index);
        }
    }
    ...
    public boolean addEdge(GraphEdge<L> edge) {
        ...
        //Sono sicuro non esista quindi lo aggiungo
    ...
    public boolean addEdge(L label1, L label2) {
        if(label1 == null || label2 == null) throw new NullPointerException("Almeno una delle due etichette dell'addEdge" +
                " è null");
    ...
    public void removeEdge(L label1, L label2) {
        if(label1 == null || label2 == null) throw new NullPointerException("Almeno una delle etichette di removeEdge è null");
        GraphNode<L> node1 = new GraphNode<>(label1);
        GraphNode<L> node2 = new GraphNode<>(label2);
    ...
    public GraphEdge<L> getEdge(GraphNode<L> node1, GraphNode<L> node2) {
        ...
        if(!nodesIndex.containsKey(node1) || !nodesIndex.containsKey(node2)) throw new IllegalArgumentException("Almeno" +
                " uno dei due nodi di getEdge non appartiene a grafo");
